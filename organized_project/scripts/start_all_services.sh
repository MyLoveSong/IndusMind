...
echo "  python QWEN3-8B/test_integration.py"
echo ""
...
if [ -n "$KILL_CMD" ]; then
    ...
    echo "  kill $KILL_CMD"
    echo ""
    echo "📖 See QWEN3-8B/README_INTEGRATION.md for detailed usage instructions"
    ...
    echo "📖 All services were already running. See QWEN3-8B/README_INTEGRATION.md for usage instructions"
fi
